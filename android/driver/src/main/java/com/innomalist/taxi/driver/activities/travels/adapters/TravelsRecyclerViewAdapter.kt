...
import com.innomalist.taxi.driver.databinding.ItemTravelBinding
import com.minimal.taxi.driver.fragment.HistoryOrderItem
import java.text.NumberFormat
import java.text.SimpleDateFormat
import java.util.*

class TravelsRecyclerViewAdapter(private val context: Context, private val requests: List<HistoryOrderItem.Edge>, val listener: OnTravelItemInteractionListener) : RecyclerView.Adapter<TravelsRecyclerViewAdapter.ViewHolder>() {
