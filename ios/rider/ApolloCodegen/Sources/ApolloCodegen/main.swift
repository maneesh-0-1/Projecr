...
struct SwiftScript: ParsableCommand {
    ...
    struct DownloadSchema: ParsableCommand {
        ...
        func run() throws {
            ...
            let endpoint = URL(string: "http://localhost:3001/graphql")!
            ...
            let folderForDownloadedSchema = fileStructure.sourceRootURL
                .apollo.childFolderURL(folderName: "rider")
    ...
    struct GenerateCode: ParsableCommand {
        ...
        func run() throws {
            ...
            let codegenOptions = ApolloCodegenOptions(codegenEngine: .default,
                                                      ...
                                                      only: nil,
                                                      operationIDsURL: nil,
                                                      outputFormat: .singleFile(atFileURL: URL(string: "./API.swift")!),
                                                      customScalarFormat: .passthrough,
                                                      suppressSwiftMultilineStringLiterals: false,
                                                      urlToSchemaFile: URL(string: "./schema.graphqls")!,
