...
import com.innomalist.taxi.rider.activities.transactions.adapters.TransactionsRecyclerViewAdapter
        ...
        this.viewModel.transactions.observe(this) {
            when(it) {
                ...
                is ViewState.Success -> {
                    ...
                    val transactionsRecyclerViewAdapter = TransactionsRecyclerViewAdapter(items)
