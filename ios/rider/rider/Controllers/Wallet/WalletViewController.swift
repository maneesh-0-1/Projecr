...
class WalletViewController: FormViewController {
    ...
    var creditsRow: PushRow<WalletQuery.Data.RiderWallet> {
        get {
            return (self.form.rowBy(tag: "credits") as? PushRow<WalletQuery.Data.RiderWallet>)!
        }
    }
    ...
    override func viewDidLoad() {
        ...
        Network.shared.apollo.fetch(query: WalletQuery()) { result in
            ...
            case .success(let data):
                ...
                if methods.riderWallets.count < 1 && self.currency == nil {
                ...
                self.creditsRow.options = methods.riderWallets
        ...
        form +++ Section(header: "", footer: self.amount == nil ? "" : NSLocalizedString("You can charge your wallet for an amount more than your \"Service Fee\" and your future Service Fees will be deducted automatically from your in-app wallet.", comment: "")) {
            ...
            <<< PushRow<WalletQuery.Data.RiderWallet>("credits") {
...
extension WalletQuery.Data.RiderWallet: Equatable {
    public static func == (lhs: WalletQuery.Data.RiderWallet, rhs: WalletQuery.Data.RiderWallet) -> Bool {
        return lhs.id == rhs.id
    }
}
